    ...
    <div className="py-8 lg:pb-20 divide-y divide-gray-700 space-y-12 lg:space-y-24">
      <div className="lg:grid lg:grid-cols-12 gap-16 text-white font-medium px-4 ml-4">
        <div className="col-span-8 relative lg:text-xl lg:leading-relaxed space-y-8 pt-8 lg:pt-16 mx-auto">
          <div className="prose">
            <p>
              TERMS OF SERVICE Last updated April 08, 2024 AGREEMENT TO OUR
              LEGAL TERMS We are Ace ADC P/L, doing business as Ace ADC
              (‘Company’, ‘we’, ‘us’, or ‘our’). We operate the website ace.com
              ...
              support@aceadc.com or by mail to Victoria 3000, Australia. These
              Legal Terms constitute a legally binding agreement made between
              you, whether personally or on behalf of an entity (‘you’), and Ace
              ADC P/L, concerning your access to and use of the Services. You
            ...
            <ol className="mt-5">
              ...
              <li className="mt-4 mb-4">
                ...
                <p className="mt-2">Our intellectual property</p>
                ...
                treaties in the United States and around the world.The Content
                and Marks are provided in or through the Services ‘AS IS’ for
                your personal, non-commercial use only.
                <br />
                <p className="mt-2 mb-4">Your use of our Services</p>
                Subject to your compliance with these Legal Terms, including the
                ‘PROHIBITED ACTIVITIES’ section below, we grant you a
                non-exclusive, non-transferable, revocable licence to: access
                the Services; and download or print a copy of any portion of the
                Content to which you have properly gained access. solely for
                your personal, non-commercial use.Except as set out in this
                section or elsewhere in our Legal Terms, no part of the Services
                ...
                without our express prior written permission.If you wish to make
                any use of the Services, Content, or Marks other than as set out
                in this section or elsewhere in our Legal Terms, please address
                your request to: support@aceadc.com. If we ever grant you the
                ...
                Content, and Marks.Any breach of these Intellectual Property
                Rights will constitute a material breach of our Legal Terms and
                your right to use our Services will terminate immediately.
                <p className="mt-2 mb-4">Your submissions and contributions</p>
                ...
                post or upload any content through the Services.Submissions: By
                ...
                without acknowledgment or compensation to you.Contributions: The
                ...
                posted shall also be treated as a Contribution.You understand
                that Contributions may be viewable by other users of the
                Services and possibly through third-party websites.When you post
                Contributions, you grant us a licence (including use of your
                ...
                works of, or incorporate into other works, your Contributions,
                and to sublicence the licences granted in this section. Our use
                and distribution may occur in any media formats and through any
                media channels.This licence includes our use of your name,
                ...
                Submission and/or Contribution; warrant that any such Submission
                and/or Contributions are original to you or that you have the
                necessary rights and licences to submit such Submissions and/or
                ...
                rights, or (c) applicable law.We may remove or edit your
                ...
                opinion we consider such Contributions harmful or in breach of
                these Legal Terms. If we remove or edit any such Contributions,
                we may also suspend or disable your account and report you to
                the authorities.
              </li>
              <strong className="underline">USER REGISTRATION</strong>
              <li className="mt-4 mb-4">
              ...
              <strong className="underline">PURCHASES AND PAYMENT</strong>
              <li className="mt-4 mb-4">
                We accept the following forms of payment:VisaMastercardAmerican
                ExpressPayPalYou agree to provide current, complete, and
                accurate purchase and account information for all purchases made
                via the Services. You further agree to promptly update account
                ...
                AU dollars.You agree to pay all charges at the prices then in
                effect for your purchases and any applicable shipping fees, and
                you authorise us to charge your chosen payment provider for any
                ...
                refuse any order placed through the Services. We may, in our
                sole discretion, limit or cancel quantities purchased per
                ...
                orders that, in our sole judgement, appear to be placed by
                dealers, resellers, or distributors.
              </li>

              <strong className="underline">SUBSCRIPTIONS</strong>
              <li className="mt-4 mb-4">
                <p className="mt-2">Billing and Renewal</p>
                ...
                email us at support@aceadc.com.
                <p className="mt-2">Fee Changes</p>
              ...
              <strong className="underline">REFUNDS POLICY</strong>
              <li className="mt-4 mb-4">
                All sales are final and no refund will be issued.
              </li>

              <strong className="underline">PROHIBITED ACTIVITIES</strong>
              <li className="mt-4 mb-4">
                ...
                Services. Upload or transmit (or attempt to upload or to
                ...
                functions, operation, or maintenance of the Services. Engage in
                ...
                collection mechanisms’ or ‘pcms’). Interfere with, disrupt, or
                create an undue burden on the Services or the networks or
                services connected to the Services. Harass, annoy, intimidate,
                or threaten any of our employees or agents engaged in providing
                any portion of the Services to you. Attempt to bypass any
                measures of the Services designed to prevent or restrict access
                to the Services, or any portion of the Services. Copy or adapt
                the Services’ software, including but not limited to Flash, PHP,
                HTML, JavaScript, or other code. Except as permitted by
                applicable law, decipher, decompile, disassemble, or reverse
                engineer any of the software comprising or in any way making up
                a part of the Services. Except as may be the result of standard
                ...
                accounts by automated means or under false pretences. Use the
                ...
                endeavour or commercial enterprise. Sell or otherwise transfer
                your profile. Use the Services to advertise or offer to sell
                goods and services.
              </li>
              ...
              <li className="mt-4 mb-4">
                ...
                represent and warrant that: The creation, distribution,
                ...
                rights of any third party. You are the creator and owner of or
                have the necessary licences, rights, consents, releases, and
                permissions to use and to authorise us, the Services, and other
                users of the Services to use your Contributions in any manner
                contemplated by the Services and these Legal Terms. You have the
                ...
                manner contemplated by the Services and these Legal Terms. Your
                ...
                against a specific person or class of people. Your Contributions
    ...
    <div className={""}>
      <Head>
        <title>
          ...
          Exam Preparation | Terms of Service
        </title>
        <meta
          name="description"
