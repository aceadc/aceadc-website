    ...
    <div className="py-8 lg:pb-20 divide-y divide-gray-700 space-y-12 lg:space-y-24">
      <div className="lg:grid lg:grid-cols-12 gap-16 text-white font-medium px-4 ml-4">
        <div className="col-span-8 relative lg:text-xl lg:leading-relaxed space-y-8 pt-8 lg:pt-16 mx-auto">
          <div className="prose">
            <p>
              Ace ADC is committed to providing quality services to you and this
              policy outlines our ongoing obligations to you in respect of how
              we manage your Personal Information. We have adopted the
              Australian Privacy Principles (APPs) contained in the Privacy Act
              1988 (Cth) (the Privacy Act). The NPPs govern the way in which we
              collect, use, disclose, store, secure and dispose of your Personal
              Information. A copy of the Australian Privacy Principles may be
            ...
            <ol className="mt-5">
              <li className="mt-2">
                ...
                ways including via our website www.aceadc.com or *.aceadc.com
                and from third parties. We don’t guarantee website links or
                policy of authorised third parties.We collect your Personal
                Information for the primary purpose of providing our services to
                you, providing information to our clients and marketing. We may
                ...
                contacting us in writing.When we collect Personal Information we
                will, where appropriate and where possible, explain to you why
              ...
              <li className="mt-4">
                <strong>Security of Personal Information</strong> <br />
              ...
              <li className="mt-4">
                ...
                writing. Ace ADC will not charge any fee for your access
            ...
            <p>ACE ADC Melbourne, Victoria 3000 Australia support@aceadc.com</p>
            <p className="mt-5">
              If you have any questions or concerns, please contact us at{" "}
              <a className="text-primary-500 underline" href="mailto:support@aceadc.com">support@aceadc.com</a>.
            </p>
          </div>
        </div>
      </div>
